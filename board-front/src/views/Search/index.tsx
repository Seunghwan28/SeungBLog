...
export default function Search() {
  ...
  //          function: get SearchBoardList response 처리 함수             //
  ...
  //          function: get RelationList response 처리 함수             //
  ...
  //          event Handler: 관련 검색어 클릭시 처리 핸들러         //
    ...
    <div id='search-wrapper'>
      <div className='search-container'>
        <div className='search-title-box'>
          ...
          <div className='search-count'>{count}<span className='search-count-word'>개</span></div>
        </div>
